...
namespace eastl
{
	...
	void* allocate_memory(Allocator& a, size_t n, size_t alignment, size_t alignmentOffset);
		...
		inline void* operator new[](size_t size, const char* pName, int flags, unsigned debugFlags, const char* file, int line) throw();
		inline void* operator new[](size_t size, size_t alignment, size_t alignmentOffset, const char* pName, int flags, unsigned debugFlags, const char* file, int line) throw();
...
#ifndef _NEW_OPERATOR_EASTL_EXAMPLE
#define _NEW_OPERATOR_EASTL_EXAMPLE

		void* operator new[]( size_t size, const char* /*name*/, int /*flags*/,
			unsigned /*debugFlags*/, const char* /*file*/, int /*line*/ ) THROW_SPEC_0//THROW_SPEC_1( std::bad_alloc )
		{
			return malloc( size );
		}

		void* operator new[]( size_t size, size_t alignment, size_t /*alignmentOffset*/, const char* /*name*/,
			int /*flags*/, unsigned /*debugFlags*/, const char* /*file*/, int /*line*/ ) THROW_SPEC_0//THROW_SPEC_1( std::bad_alloc )
		{
			// Substitute your aligned malloc.
			return _aligned_malloc( size, alignment );
		}
#endif // !_NEW_OPERATOR_EASTL_EXAMPLE
	#endif
