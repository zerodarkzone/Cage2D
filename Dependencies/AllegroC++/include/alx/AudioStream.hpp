...
public:
    ...
    AudioStream(const char *filename, size_t bufferCount, size_t sampleCount) :
        Shared(al_load_audio_stream(filename, bufferCount, (int)sampleCount), al_destroy_audio_stream)
    {
    }
    ...
    AudioStream(const File &file, const char *ext, size_t bufferCount, size_t sampleCount) :
        Shared(al_load_audio_stream_f(file.get(), ext, bufferCount, (int)sampleCount), al_destroy_audio_stream)
    {
    }
    ...
    bool load(const char *filename, size_t bufferCount, size_t sampleCount) {
        reset(al_load_audio_stream(filename, bufferCount, (int)sampleCount), al_destroy_audio_stream);
        return (bool)(*this);
    }
    ...
    bool load(const File &file, const char *ext, size_t bufferCount, size_t sampleCount) {
        reset(al_load_audio_stream_f(file.get(), ext, bufferCount, (int)sampleCount), al_destroy_audio_stream);
        return (bool)(*this);
    }
